...
public sealed class TestCaseExecutorTests
{
    ...
    public void Execute_ValidExecution_ShouldReturnValue()
    {
        ...
        var container = TestSuiteTestFactory.CreateEmptyContextContainer(operation: (int x, int y) => x + y);
        ...
        var testCase = TestSuiteTestFactory.CreateTestCase(input, expectedResult);
    ...
    public void Execute_WithExceptionThrownOperation_ShouldReturnException()
    {
        ...
        var container = TestSuiteTestFactory.CreateEmptyContextContainer(operation: (int _, int _) =>
        {
            throw exception;
        });
        ...
        var testCase = TestSuiteTestFactory.CreateTestCase([1, 2], 3);
        var sw = new Stopwatch();
    ...
    public void Execute_InvalidInput_ShouldReturnExceptionWithValidation()
    {
        ...
        var testCase = TestSuiteTestFactory.CreateTestCase(input, 6);
        var sw = new Stopwatch();
